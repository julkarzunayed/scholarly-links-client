            ...
            <div className=" bg-gradient-to-r from-primary from-50%  to-teal-500 to-90% p-[3px] flex rounded-full w-full">
                <form
                    ...
                    <input
                        ...
                        name='email'
                        type="text"
                        className='text-white focus:outline-0 flex-1 p-3 bg-accent pl-8 rounded-l-full'
                        placeholder='Your Email' />
                    <button
                        role='submit'
                        className='text-lg py-3 px-8 font-bold text-gray-50 active:text-secondary rounded-r-full hover:bg-white/20'>
                        Subscribe
                    </button>
                </form>
            </div>

...
const RejectedPublishersApplications = () => {
    ...
    const handleTakeAction = (email) => {
        ...
        Swal.fire({
            icon: 'question',
            title: "Do you want to <strong>Approve</strong> The Publisher?",
            showCancelButton: true,
            cancelButtonText: 'X',
            confirmButtonText: "Approve",
            confirmButtonColor: '#31bf18'
        }).then(async (result) => {
            // check chosen option
    ...
    return (
        <div className="overflow-x-auto pt-10 p-1 ">
            <h1 className="text-center mb-3 text-4xl font-bold font-playfair-display text-red-600">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-sm opacity-50">
                                                        ...
                                                        <span className="border border-orange-300 text-gray-800 font-semibold bg-orange-200 py-0.5 px-3 rounded-2xl">
                                                            {publisher?.status}
                                                        </span>
                                                    </div>
                                                </div>
                    ...
                    <div className="h-[50vh] flex items-center justify-center">
                        <div className="text-center flex justify-center items-center flex-col">
                            ...
                            <h2 className="text-2xl  font-roboto text-green-700">
                                No Rejected Publisher Application
                            </h2>
...
export default RejectedPublishersApplications;
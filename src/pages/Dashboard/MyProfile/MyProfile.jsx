            ...
            <div className="relative   min-h-[308px] shadow-lg pb-5 rounded-2xl">
                ...
                <div className="flex flex-col pb-2 md:flex-row  md:items-end gap-4">
                    <div className="avatar relative mx-auto md:mx-0 md:ml-14">
                        <div
                            className="mask avatar mask-squircle w-48 h-48 bg-white flex items-center justify-center bg-center bg-contain">
                            <div
                                style={{
                ...
                <div className="text-end p-2  border-red-500">
                    <button className='btn  btn-primary text-gray-700 animate-bounc relative'>
